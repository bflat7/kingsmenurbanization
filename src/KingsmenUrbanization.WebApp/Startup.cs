...
namespace KingsmenUrbanization.WebApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IUrbanizationDbContext>(s =>
            {
                var optionsBuilder = new DbContextOptionsBuilder<UrbanizationDbContext>();
                optionsBuilder.UseSqlServer(Configuration.GetConnectionString("DefaultConnection"));
                return new UrbanizationDbContext(optionsBuilder.Options);
            });
